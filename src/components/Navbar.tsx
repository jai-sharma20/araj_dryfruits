              ...
              {currentUser ? (
                <div className="flex items-center space-x-4">
                  ...
                  <button 
                    ...
                    className="text-gray-700 hover:text-maroon-600 transition-all duration-200 transform hover:scale-110 hover:-translate-y-0.5"
                  >
            ...
            <div className="md:hidden animate-slide-down">
              <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                ...
                {currentUser && (
                  <button
                    onClick={handleLogout}
                    className="block w-full text-left px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-maroon-600 hover:bg-gray-50 transition-all duration-200 transform hover:scale-105"
                  >
                    Sign Out
                  </button>
                )}
